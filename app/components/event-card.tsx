  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-6">
        ...
        {/* Title */}
        <h3 className="text-lg md:text-xl font-bold text-[rgb(var(--theme-on-surface))] mb-3 md:mb-4 line-clamp-1">
          {title}
        </h3>
        ...
        <Link href={ctaLink}>
          <Button 
            className="w-full bg-[rgb(var(--theme-primary))] hover:bg-[rgb(var(--theme-primary)/.8)] text-white text-sm md:text-base py-2 md:py-2.5 transition-colors duration-200 rounded-none cursor-pointer"
          >
            Learn More
          </Button>
        </Link>
